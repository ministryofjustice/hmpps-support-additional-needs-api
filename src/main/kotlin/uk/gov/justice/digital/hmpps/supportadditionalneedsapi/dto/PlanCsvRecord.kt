...
data class PlanCsvRecord(
  ...
  companion object {
    fun from(entity: PlanCreationScheduleEntity): PlanCsvRecord = PlanCsvRecord(
    ...
    fun fromList(entities: List<PlanCreationScheduleEntity>): List<PlanCsvRecord> = entities.map { from(it) }
  }
}
