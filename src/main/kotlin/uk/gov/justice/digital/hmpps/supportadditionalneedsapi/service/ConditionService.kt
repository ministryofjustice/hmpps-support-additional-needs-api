...
class ConditionService(
    ...
    private fun resolveConditionTypes(request: CreateConditionsRequest): List<Pair<ReferenceDataEntity, ConditionRequest>> =
        request.conditions.map { conditionRequest ->
